...
/*
HARD CODED CHANGES HAPPEN HERE!
The next three lines variables are the ones that need to be changed for your upload!
 */
...
$STD_FIELDS = array(
    ...
    'profile_field_supervisor',
    'profile_field_workplace',
);
...
// Moodle internal definitions -> Source: /admin/tool/uploaduser/locallib.php line 28 - 45
/*
...
$optype = UU_USER_ADD_UPDATE;
$updatetype = UU_UPDATE_ALLOVERRIDE;
$createpasswords = 0;
$updatepasswords = 0;
$allowrenames = 1; // 0: No; 1: Yes
$allowdeletes = 0; // 0: No; 1: Yes
$allowsuspends = 1; // 0: No; 1: Yes
$bulk = 0; // 0: No; 1: Yes
$noemailduplicates = 0; // 0: No (Duplicates are allowed); 1: Yes
$standardusernames = 0; // 0: No; 1: Yes
$resetpasswords = UU_PWRESET_WEAK;
...
// do not insert record if new auth plugin does not exist!
        ...
        if (!validate_email($user->email)) {
// *NT* This is where the email is set for new users with no email address.
            $user->email = $defaultmail;
        }
